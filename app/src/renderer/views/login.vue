    ...
    <Form ref='form' class="login-form">
      ...
      <div class="fields">
        <Form-item prop="account" style="margin-bottom: 0">
          <Input class="field" v-model="login.account" placeholder="账号" width="320px">
          </Input>
        </Form-item>
        <Form-item prop="password" style="margin-bottom: 0">
          <Input class="field" v-model="login.password" type="password" placeholder="密码" width="320px" @keyup.native.enter="check">
          </Input>
        </Form-item>
      ...
      <div class="submit">
        <Button long @click.native="check" type="primary" :loading="loading">{{ loading ? '登录中' : '登录' }}</Button>
      </div>
    </Form>
